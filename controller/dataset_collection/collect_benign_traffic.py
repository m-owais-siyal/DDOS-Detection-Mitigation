...
class CollectTrainingStatsApp(switch.SimpleSwitch13):
    ...
    def _flow_stats_reply_handler(self, ev):
        ...
        for stat in sorted([flow for flow in body if flow.priority == 1],
            ...
            # Submit file write as a separate task to ThreadPoolExecutor
            self.executor.submit(self.write_to_file, timestamp, ev.msg.datapath.id, flow_id, ip_src, tp_src, ip_dst,
                                 tp_dst, stat.match['ip_proto'], icmp_code, icmp_type, stat.duration_sec,
                                 stat.duration_nsec, stat.idle_timeout, stat.hard_timeout, stat.flags,
                                 stat.packet_count, stat.byte_count, packet_count_per_second,
                                 packet_count_per_nsecond, byte_count_per_second, byte_count_per_nsecond, 0)

    def write_to_file(self, timestamp, datapath_id, flow_id, ip_src, tp_src, ip_dst, tp_dst, ip_proto,
        ...
        # Avoid race conditions by opening the file in append mode within the function
        with open("FlowStatsfile.csv", "a+") as file0:
            file0.write("{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}\n"
                        .format(timestamp, datapath_id, flow_id, ip_src, tp_src, ip_dst, tp_dst,
...
if __name__ == '__main__':
    switch = CollectTrainingStatsApp()
    switch.start()
